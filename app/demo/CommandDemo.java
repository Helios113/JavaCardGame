...
public class CommandDemo {
	...
	// 	// setPlayerHealth
	// 	BasicCommands.addPlayer1Notification(out, "setPlayerHealth", 2);
	// 	Player humanPlayer = new Player(20, 0);
	// 	BasicCommands.setPlayerHealth(out, humanPlayer);
	// 	try {Thread.sleep(2000);} catch (InterruptedException e) {e.printStackTrace();}

	// 	// setPlayerHealth
	// 	BasicCommands.addPlayer1Notification(out, "setPlayerHealth", 2);
	// 	Player aiPlayer = new Player(20, 0);
	// 	BasicCommands.setPlayerHealth(out, aiPlayer);
	// 	try {Thread.sleep(2000);} catch (InterruptedException e) {e.printStackTrace();}

	// 	// Mana
	// 	for (int m = 0; m<10; m++) {
	// 		BasicCommands.addPlayer1Notification(out, "setPlayerMana ("+m+")", 1);
	// 		humanPlayer.setMana(m);
	// 		BasicCommands.setPlayerMana(out, humanPlayer);
	// 		try {Thread.sleep(1000);} catch (InterruptedException e) {e.printStackTrace();}
	// 	}
	...
	// 		BasicCommands.addPlayer1Notification(out, "setPlayerMana ("+m+")", 1);
	// 		aiPlayer.setMana(m);
	// 		BasicCommands.setPlayerMana(out, aiPlayer);
	// 		try {Thread.sleep(1000);} catch (InterruptedException e) {e.printStackTrace();}
	// 	}
