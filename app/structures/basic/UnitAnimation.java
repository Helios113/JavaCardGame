...
public class UnitAnimation {
	...
	/**
	 * method to get the run time of a one shot animation
	 * @return execution time of animation
	 */
	public long getLength() {
		return (long)(1000*(frameStartEndIndices[1]-frameStartEndIndices[0])/fps);
	}
