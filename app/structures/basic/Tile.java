...
public class Tile {
	...
	// AS just checking what the mode numbering is. 0 = not highlighted, 1 = highlight white, 2 = red? 
	int mode; 
	...
	public boolean hasUnit() {
		return this.unit==null?false:true;
	}
	...
	public boolean equals(Tile that) {
		...
		if(this.tilex == that.tilex && this.tiley == that.tiley) return true;
		return false;
	}
